  ...
  <html lang="en">
      ...
      <body>
          <header>
              ...
              <p>
                  ...
                  <strong>aniwatchtv.to</strong>. Built for developers who want
      ...
      "data": {}
                  ...
                  <div class="card">
                      <h2>⚠️ Disclaimer</h2>
                      <p>
                          This API is not affiliated with aniwatchtv.to. All content
              ...
              <section class="section">
                  <h2>🔧 Quick Start</h2>
                  <div class="card">
                      <pre><code>git clone https://github.com/yahyaMomin/aniwatch-API.git
    cd aniwatch-API
    bun install
    bun run dev</code></pre>
          ...
          <footer>
              <p>
                  ...
                  ·
                  <a
                      href="https://github.com/yahyaMomin/aniwatch-API"
                      target="_blank"
                  >
                      GitHub
                  </a>
